...
abstract class TenantMapper {
    @org.mapstruct.Mappings(org.mapstruct.Mapping(source = "sysPackageId", target = "sysPackage.id"), org.mapstruct.Mapping(source = "sysPackageName", target = "sysPackage.name"))
    abstract fun toEntity(tenantVO: TenantVO): Tenant
    @org.mapstruct.Mappings(org.mapstruct.Mapping(source = "sysPackage.id", target = "sysPackageId"), org.mapstruct.Mapping(source = "sysPackage.name", target = "sysPackageName"))
